...
\begin{itemize}
    ...
    \item If both address type and address list filter option is used, then the type of the addresses in the list must be match with the specified address type.
\end{itemize}
...
\msubsection{struct}{DeviceResponse}
